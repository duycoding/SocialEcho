				...
				<div
						...
						<div className='mt-3 text-center sm:mt-5'>
							...
							<div className='mt-2'>
								<p className='text-sm text-gray-500'>
									Người dùng này sẽ bị cấm khỏi cộng đồng và sẽ được liệt kê
									trong danh sách người dùng bị cấm. Người dùng sẽ không thể
									tham gia lại cộng đồng trừ khi lệnh cấm được gỡ bỏ. Bạn có
									chắc chắn muốn cấm người dùng này không?
								</p>
							</div>
						</div>
					</div>
					<div className='mt-5 flex justify-center space-x-2 sm:mt-6'>
						...
						<button
							...
							{banning ? (
								<LoadingSpinner loadingText={'Đang chặn...'} />
							) : (
