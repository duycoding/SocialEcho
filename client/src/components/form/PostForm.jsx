	...
	const handleFileChange = (event) => {
		...
		if (
			...
			setFormData({
				...formData,
				file: null,
				error: 'Vui lòng chọn hình ảnh hoặc video kích thước nhỏ hơn 50MB.',
			});
		}
	};
			...
			<form
				...
				<div className='mb-4'>
					<label
						...
						Chia sẻ điều gì đó tới cộng đồng của bạn
					</label>
					<textarea
				...
				<div className='mb-4'>
					<label
						...
						<h2 className='mx-3 text-gray-400'>Hình ảnh / Video</h2>
						<input
							name='file'
							type='file'
							id='file'
				...
				<button
					...
					{formData.loading ? 'Processing...' : 'Đăng'}
				</button>
			</form>
		</>
	);
